...
LOGGER = logging.getLogger("difd.busternet_core")
...
def create_BusterNet_testing_model( weight_file=None ) :
    ...
    if weight_file is not None :
        try :
            ...
            LOGGER.info("Successfully loaded pretrained weights from %s", weight_file)
        except Exception as e :
            LOGGER.exception("Failed to load pretrained weights from %s", weight_file)
    return model
